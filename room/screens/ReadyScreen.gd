...
onready var ready_button := $Panel2/ReadyButton
onready var match_id_container := $Panel2/MatchIDContainer
onready var match_id_label := $Panel2/MatchIDContainer/MatchID
